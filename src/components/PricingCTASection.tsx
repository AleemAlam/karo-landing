...
export default function PricingCTASection() {
  ...
  return (
    <>
      {/* Mobile Layout */}
      <section className="lg:hidden bg-[#F3F3EF]">
        {/* Orange Border Card */}
        <div className="border-8 border-orange-500 bg-white p-6">
          <div className="text-center">
            {/* Top Text */}
            <p className="text-black text-[34px] font-extrabold mb-2">{t('topText')}</p>

            {/* Main Heading - Orange Italic */}
            <h2 className="text-[34px] font-extrabold text-orange-500 italic mb-4">
              {t('heading')}
            </h2>

            {/* Subtext */}
            <p className="text-black text-3xl font-extrabold whitespace-pre-line mb-6">
              {t('subText')}
            </p>
            ...
            {/* Today's Price */}
            <div className="bg-[#F3F3EF] p-4 mb-6">
              <p className="text-black text-xl font-bold mb-2">{t('todayPriceLabel')}</p>
            ...
            {/* Countdown */}
            <div className="mb-6">
              <p className="text-[#2C3A3A] text-sm mb-2">{t('countdownLabel')}</p>
              <div className="flex items-center justify-center gap-2">
                <div className="bg-white border border-gray-300 px-4 py-2">
                  <span className="text-black text-3xl font-bold">
                    {formatTime(timeLeft.minutes)}:{formatTime(timeLeft.seconds)}
                  </span>
                </div>
                <span className="text-[#2C3A3A] text-sm">{t('countdownUnit')}</span>
              </div>
            </div>
      ...
      {/* Desktop Layout */}
      <section className="hidden lg:block bg-[#F3F3EF] mx-20">
        <div className="mx-20">
          {/* Orange Border Card */}
          <div className="border-8 border-orange-500 bg-[#F3F3EF] py-12 px-16">
            <div className="text-center">
              ...
              {/* Main Heading - Orange Italic */}
              <h2 className="text-7xl font-extrabold text-orange-500 italic mb-4">
                {t('heading')}
              </h2>
              ...
              <div className="flex items-center justify-center gap-2 mb-8">
                <span className="text-[#2C3A3A] text-base">{t('countdownLabel')}</span>
                <span className="text-black text-4xl font-bold">
                  {formatTime(timeLeft.minutes)}:{formatTime(timeLeft.seconds)}
                </span>
                <span className="text-[#2C3A3A] text-base">{t('countdownUnit')}</span>
              </div>
