      ...
      <div className="px-4 lg:px-20 mx-auto">
        ...
        <div className="lg:hidden space-y-4">
          ...
          <div className="bg-white rounded-lg overflow-hidden">
            <h3 className="text-lg font-bold text-black p-4 bg-gray-50">{t('modulesTitle')}</h3>
            {modules.map((module, index) => (
              <MobileCard key={index} title={module.title} description={module.description} value={module.value} />
            ))}
          </div>

          {/* Community Section */}
          <div className="bg-white rounded-lg overflow-hidden">
            <h3 className="text-lg font-bold text-black p-4 bg-gray-50">{t('communityTitle')}</h3>
            {community.map((item, index) => (
              <MobileCard key={index} title={item.title} description={item.description} value={item.value} />
            ))}
          </div>

          {/* Coaching Section */}
          <div className="bg-white rounded-lg overflow-hidden">
            <h3 className="text-lg font-bold text-black p-4 bg-gray-50">{t('coachingTitle')}</h3>
          ...
          {/* Tools Section */}
          <div className="bg-white rounded-lg overflow-hidden">
            <h3 className="text-lg font-bold text-black p-4 bg-gray-50">{t('toolsTitle')}</h3>
          ...
          {/* Total */}
          <div className="flex justify-between items-center py-4 px-4 bg-white rounded-lg">
            <h3 className="text-xl font-bold text-black">{t('totalLabel')}</h3>
